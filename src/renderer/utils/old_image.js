  ...
  function cal_symmetry(rows, columns, pixel_data_16, pixel_data_8) {
      ...
      for (var i = left_Boundary_subscript_index_x; i < int_cy; i++) {
          if (Math.abs(penumbra_mat.ushortAt(int_cx, i) - left_fifty_percent_dose_value) < 2) {
      ...
      for (var i = int_cy; i < right_Boundary_subscript_index_x; i++) {
          if (Math.abs(penumbra_mat.ushortAt(int_cx, i) - right_fifty_percent_dose_value) < 2) {
  ...
  function cal_uniformity(rows, columns, pixel_data_16, pixel_data_8, image_shape) {
      console.log(rows, columns, pixel_data_16, pixel_data_8, image_shape)
  ...
  function cal_position_indication(rows, columns, first_pixel_data_16, first_pixel_data_8, first_image_shape, second_pixel_data_16, second_pixel_data_8, second_image_shape) {
      ...
      for (var i = 1; i < first_int_cy; i++) {
          if (first_mat_8.ucharAt(first_int_cx, i) < 140) {
      ...
      var first_D_value = first_half_dose_value_distance - 200;
      ...
      for (var i = 1; i < second_int_cy; i++) {
          if (second_mat_8.ucharAt(second_int_cx, i) < 140) {
      ...
      for (var i = second_left_Boundary_subscript_index_x; i < second_int_cy; i++) {
          if (Math.abs(second_mat_8.ucharAt(second_int_cx, i) - second_left_half_dose_value) < 2) {
      ...
      for (var j = second_int_cy; j < second_right_Boundary_subscript_index_x; j++) {
          if (Math.abs(second_mat_8.ucharAt(second_int_cx, j) - second_right_half_dose_value) < 2) {
      ...
      var second_D_value = second_half_dose_value_distance - 200;
  ...
  function cal_scale_position(rows, columns, first_pixel_data_16, first_pixel_data_8, first_image_shape, second_pixel_data_16, second_pixel_data_8, second_image_shape) {
      ...
      console.log("two image max D_value is " + max_D_value);
      var t_left_D_value = Math.abs(second_left_dose_value_index - first_left_dose_value_index);
      var t_right_D_value = Math.abs(second_right_dose_value_index - first_right_dose_value_index);
      var t_D_value = (t_right_D_value + t_left_D_value) / 2;
      console.log(t_left_D_value, t_right_D_value);
      console.log("t_D_value is " + t_D_value);
      return t_D_value;
  }
  ...
  function cal_penumbra(rows, columns, pixel_data_16, pixel_data_8) {
      ...
      for (var i = left_Boundary_subscript_index_x; i < int_cy; i++) {
          if (Math.abs(penumbra_mat.ushortAt(int_cx, i) - left_twenty_percent_dose_value) < 2) {
              left_twenty_percent_dose_index = i;
              break;
          }
      }
      for (var i = left_Boundary_subscript_index_x; i < int_cy; i++) {
          if (Math.abs(penumbra_mat.ushortAt(int_cx, i) - left_eighty_percent_dose_value) < 2) {
      ...
      for (var j = int_cy; j < right_Boundary_subscript_index_x; j++) {
          if (Math.abs(penumbra_mat.ushortAt(int_cx, j) - right_twenty_percent_dose_value) < 2) {
              right_twenty_percent_dose_index = j;
              break;
          }
      }
      for (var j = int_cy; j < right_Boundary_subscript_index_x; j++) {
          if (Math.abs(penumbra_mat.ushortAt(int_cx, j) - right_eighty_percent_dose_value) < 2) {
  ...
  function cal_small_multiple_limiting(rows, columns, pixel_data_16, pixel_data_8, pairs_number) {
      ...
      if (pairs_number == 40) {
          ...
          for (var j = 1; j < 11; j++) {
              for (var i = left_Boundary_subscript_index_x; i < int_cy; i++) {
                  if (Math.abs(penumbra_mat.ushortAt(up_Boundary_subscript_index_y + j * small_multiple_Grating_spacing_index_number, i) - left_fifty_percent_dose_value) < 2) {
          ...
          for (var j = 1; j < 11; j++) {
              for (var i = int_cy; i < right_Boundary_subscript_index_x; i++) {
                  if (Math.abs(penumbra_mat.ushortAt(up_Boundary_subscript_index_y + j * small_multiple_Grating_spacing_index_number, i) - right_fifty_percent_dose_value) < 2) {
          ...
          return small_multiple_max_fifty_percent_dose_distance_D_value;
      }
      //cal 80 pairs
      else {
          var large_multiple_Grating_spacing = (10 * 0.8) / 2;
          var large_multiple_Grating_spacing_index_number = small_multiple_Grating_spacing / 0.4;
          var large_multiple_left_fifty_percent_dose_index_array = [];
          for (var j = 1; j < 21; j++) {
              for (var i = left_Boundary_subscript_index_x; i < int_cy; i++) {
                  if (Math.abs(penumbra_mat.ushortAt(up_Boundary_subscript_index_y + j * large_multiple_Grating_spacing_index_number, i) - left_fifty_percent_dose_value) < 2) {
          ...
          return large_multiple_max_fifty_percent_dose_distance_D_value;
      }
  }
  ...
  function cal_large_muliiple_limiting(rows, columns, first_pixel_data_16, first_pixel_data_8, pairs_number, second_pixel_data_16, second_pixel_data_8) {
      ...
      for (var i = 0; i < first_int_cx; i++) {
          if (first_mat_8.ucharAt(i, first_int_cy) < 140) {
      ...
      for (var i = 0; i < second_int_cx; i++) {
          if (second_mat_8.ucharAt(i, second_int_cy) < 140) {
